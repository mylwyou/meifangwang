...
class Page{
    ...
    public $rollPage   = 8;//11 分页栏每页显示的页数
    ...
    private $config  = array(
        'header' => '<li><a href="#">共 %TOTAL_ROW% 条,每页%LISTROWS%条,第%NOW_PAGE%/%TOTAL_PAGE%页</a></li>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '首页...',
        'last'   => '...尾页',
...
//                     $link_page .= '<li class="active"><span class="current">' . $page . '</span></li>';
        ...
        $page_str = str_replace(
            array('%HEADER%', '%NOW_PAGE%', '%UP_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%','%LISTROWS%'),
